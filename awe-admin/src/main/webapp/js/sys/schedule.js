...
var vm = new Vue({
	...
	methods: {
		...
		update: function () {
			...
			$.get("../sys/schedulejob/info/"+jobId, function(r){
				vm.showList = false;
                vm.title = "修改";
		...
		saveOrUpdate: function (event) {
			var url = vm.schedule.jobId == null ? "../sys/schedulejob/save" : "../sys/schedulejob/update";
			$.ajax({
				type: "POST",
			    url: url,
